...
function getInfoBasedOnScore(){
    if(totalScore() < 7){
        var score_info = "Você ainda precisa aprender bastante conosco!";
    } else if(totalScore() > 7){
        var score_info = "Parabéns! Iremos auxilia-lo a melhorar seus conhecimentos!"
    }
